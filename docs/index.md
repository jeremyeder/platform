...
# Clone and deploy
git clone https://github.com/jeremyeder/platform.git
cd platform
make dev-start
```
...
- **Questions**: [GitHub Discussions](https://github.com/jeremyeder/platform/discussions)
- **Source Code**: [GitHub Repository](https://github.com/jeremyeder/platform)
