...
export default function ProjectsPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Sticky header */}
      <div className="sticky top-0 z-20 bg-surface-primary/95 backdrop-blur supports-[backdrop-filter]:bg-surface-primary/80 border-b border-border-light">
        ...
        <Card className="bg-surface-primary border-border-light">
          <CardHeader>
            <div className="flex items-start justify-between">
              <div>
                <CardTitle className="text-text-primary">Workspaces</CardTitle>
