...
// Breadcrumbs removed - sidebar now handles navigation
...
export default function ProjectSessionDetailPage({
  ...
  if (isLoading || !projectName || !sessionName) {
    return (
      <div className="absolute inset-0 top-16 overflow-hidden bg-surface-primary flex items-center justify-center h-full">
  ...
  if (error || !session) {
    return (
      <div className="absolute inset-0 top-16 overflow-hidden bg-surface-primary flex flex-col h-full">
  ...
  return (
    <>
      <div className="absolute inset-0 top-16 overflow-hidden bg-surface-primary flex flex-col h-full">
        {/* Fixed header */}
        <div className="flex-shrink-0 bg-surface-primary border-b border-border-light">
          <div className="px-6 py-4">
            <div className="space-y-3 md:space-y-0">
              {/* Top row: Session name + Status + Kebab menu */}
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3 md:hidden">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-sm font-medium truncate max-w-[150px] text-text-primary">
                ...
                {/* Desktop: Session name + Status badge */}
        ...
        {session && (
          <div className="md:hidden px-6 py-1 bg-surface-primary border-b border-border-light">
            <Button
              variant="outline"
              size="sm"
        ...
        {/* Main content area */}
        <div className="flex-grow overflow-hidden bg-surface-primary">
          <div className="h-full relative">
            ...
            {session && mobileMenuOpen && (
                ...
                "w-[400px] h-[calc(100vh-4rem)] pt-6 pl-6 pr-6 bg-surface-primary relative",
                ...
                <div className={cn(
                  ...
                  >
                    ...
                    <AccordionItem
                      value="file-explorer"
                      className="border border-border-light rounded-lg px-3 bg-surface-primary"
                    >
                                  ...
                                  return (
                                    ...
                                    >
                                      <div className="flex items-center gap-2 flex-wrap w-full">
                                        ...
                                        {branchName && (
                                          <Badge variant="outline" className="text-xs px-1.5 py-0.5 max-w-full !whitespace-normal !overflow-visible break-words bg-muted text-foreground border-border">
                                            {branchName}
                                          </Badge>
                                        )}
                                      </div>
                          ...
                          <div className="space-y-2">
                            ...
                            {!githubConfigured && (
                              <Alert variant="default" className="border-border bg-muted">
                                ...
                                <AlertTitle className="text-foreground">GitHub Not Configured</AlertTitle>
            ...
            <ResizablePanelGroup direction="horizontal" autoSaveId="session-layout" className="hidden md:flex h-full">
              {leftPanelVisible && session && (
                <>
                  ...
                  >
                    <div className={cn(
                      "flex flex-col h-[calc(100vh-8rem)] pt-6 px-6 bg-surface-primary relative",
                      phase !== "Running" && "pointer-events-none"
                    )}>
                      {/* Backdrop blur layer for entire sidebar */}
                      {phase !== "Running" && (
