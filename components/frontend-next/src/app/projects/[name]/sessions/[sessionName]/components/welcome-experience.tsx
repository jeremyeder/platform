          ...
          <div className="mb-4 mt-6">
            <div className="flex space-x-3 items-start">
              ...
              <div className="flex-shrink-0">
                <div className="w-8 h-8 rounded-full flex items-center justify-center bg-muted border border-border-light">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
                {enabledWorkflows.map((workflow, index) => (
                  <Card
                    ...
                    className={cn(
                      "py-2 cursor-pointer transition-all bg-surface-secondary hover:bg-surface-hover border-border-light hover:border-border-medium",
                  ...
                  >
                    <CardContent className="p-3 space-y-1">
                      <h3 className={cn(
                        ...
                        selectedWorkflowId !== null && selectedWorkflowId !== workflow.id && "text-muted-foreground"
                      )}>
                        {workflow.name}
                      </h3>
                      <p className={cn(
                        "text-xs line-clamp-2 text-text-secondary",
              ...
              >
                <DropdownMenu onOpenChange={(open) => {
                  ...
                  <DropdownMenuTrigger asChild>
                    <Button
                      variant="ghost"
                      className="text-sm text-text-secondary hover:text-text-primary hover:bg-transparent p-0 h-auto cursor-pointer"
