...
export function WorkflowsAccordion({
  ...
  return (
    <AccordionItem value="workflows" className="border border-border-light rounded-lg px-3 bg-surface-primary">
      <AccordionTrigger className="text-base font-semibold hover:no-underline py-3">
        <div className="flex items-center gap-2">
          <Workflow className="h-4 w-4" />
          <span>Workflows</span>
          {activeWorkflow && !isExpanded && (
            <Badge variant="outline" className="bg-surface-secondary text-foreground border-border">
