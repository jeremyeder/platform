...
const getColorClassesForName = (name: string) => {
  const mono = { avatarBg: "bg-muted-foreground/20", badgeBg: "bg-muted", cardBg: "bg-muted/10", border: "border-border", badgeText: "text-foreground", badgeBorder: "border-border" };
  const colorChoices = [mono, mono, mono, mono, mono, mono, mono, mono, mono, mono];
  ...
  return (
    <div className="py-1">
      <div 
        ...
        onClick={() => setExpanded(!expanded)}
      >
        {isError && <X className="w-3 h-3 text-destructive flex-shrink-0" />}
        {isSuccess && <Check className="w-3 h-3 text-muted-foreground flex-shrink-0" />}
        {isPending && <Loader2 className="w-3 h-3 animate-spin text-muted-foreground flex-shrink-0" />}
          ...
          <div className="flex-1 min-w-0">
            ...
            <div
              className={cn(
                ...
                isSubagent ? "bg-muted/10" : "",
                isSubagent ? "border-border" : undefined
              )}
            >
              {/* Collapsible Header */}
              <div
                ...
                <div className={cn("flex items-center flex-1 min-w-0", isCompact ? "space-x-1.5" : "space-x-2")}>
                  ...
                  {!isCompact && (
                    <div className="flex-shrink-0">
                      ...
                      {isSuccess && <Check className="w-4 h-4 text-muted-foreground" />}
                  ...
                  {isCompact && (
                    <div className="flex-shrink-0">
                      ...
                      {isSuccess && <Check className="w-3 h-3 text-muted-foreground" />}
                  ...
                  <div className="flex-shrink-0">
                    <Badge
                      className={cn(
                        ...
                        isSubagent && "bg-muted text-foreground",
              ...
              {isSubagent && isExpanded ? (
                ...
                isExpanded && (
                  <div className="px-3 pb-3 space-y-3 bg-surface-secondary/50">
                    {toolUseBlock?.input && (
                      <div>
                        <h4 className="text-xs font-medium text-foreground/80 mb-1">Input</h4>
                        <div className="bg-muted rounded text-xs p-2 overflow-x-auto">
