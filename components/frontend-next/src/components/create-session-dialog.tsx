          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="w-full space-y-2">
                ...
                {/* GitHub card */}
                {githubConfigured ? (
                  <div className="flex items-start justify-between gap-3 p-3 border border-border-light rounded-lg bg-surface-primary">
                  ...
                  <div className="flex items-start gap-3 p-3 border border-border-light rounded-lg bg-surface-primary">
                    <div className="flex-shrink-0">
