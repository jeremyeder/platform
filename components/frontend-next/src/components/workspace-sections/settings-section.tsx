...
export function SettingsSection({ projectName }: SettingsSectionProps) {
  ...
  return (
    <div className="flex-1 space-y-6">
      ...
      {project?.isOpenShift ? (
        <Card className="bg-surface-primary border-border-light">
          <CardHeader>
      ...
      <Card className="bg-surface-primary border-border-light">
        <CardHeader>
          <CardTitle className="text-text-primary">Integration Secrets</CardTitle>
        ...
        <CardContent className="space-y-6">
          ...
          {/* Migration Notice */}
          <div className="border rounded-lg p-4 bg-muted/50 border-border-light">
            <h3 className="text-sm font-semibold mb-2 text-text-primary">Integration Credentials Moved</h3>
