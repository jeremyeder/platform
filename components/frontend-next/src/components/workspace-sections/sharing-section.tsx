...
export function SharingSection({ projectName }: SharingSectionProps) {
  ...
  return (
    <>
      ...
      <Card className="flex-1 bg-surface-primary border-border-light">
        <CardHeader>
          <div className="flex items-start justify-between">
            <div>
              ...
              <CardDescription className="text-text-secondary">Users and groups with access to this workspace and their roles</CardDescription>
            </div>
      ...
      <Dialog open={showGrantDialog} onOpenChange={setShowGrantDialog}>
        <DialogContent>
          ...
          <div className="space-y-4">
            ...
            {grantError && <div className="text-sm text-destructive bg-muted/50 p-2 rounded border border-border-light">{grantError}</div>}
          </div>
          <DialogFooter>
            <Button
              variant="outline"
