      ...
      <div className="p-6 flex flex-col flex-1">
        ...
        <div className="flex items-start gap-4 mb-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-muted-foreground">AI-powered code review assistant</p>
          </div>
        </div>
        ...
        <div className="mb-4">
          ...
          <p className="text-muted-foreground">
            Connect to CodeRabbit for AI-powered code reviews across all sessions
          </p>
        </div>
          ...
          <div className="mb-4 space-y-3">
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                ...
                <a
                  href="https://app.coderabbit.ai/settings"
                  target="_blank"
